...
BLOCKED_ENVS="RUNTIME_STARTED_WEBHOOK AWS_ACCESS_KEY_ID AWS_SECRET_ACCESS_KEY BUCKET_NAME BUCKET_ENDPOINT BUCKET_URI DOMAIN REPO_BRANCH  ORCHESTRATOR_URL GITHUB_REPO_FULLNAME AWS_RESPONSE_CHECKSUM_VALIDATION AWS_REQUEST_CHECKSUM_CALCULATION CONTAINER_ID WEBHOOK_URI FAILED_WEBHOOK PROVISIONING_WEBHOOK BUILDING_WEBHOOK PRODUCTION_WEBHOOK TERMINATED_WEBHOOK CLONE_TOKEN PROJECT_ID REPO_CLONE_URI  SOFT_MEMORY_LIMIT COMMIT_HASH BUILD_ID CURR_ENV_ID ENVIRONMENT_TYPE INSTANCE_MEMORY_LIMIT APPLICATION_MEMORY_LIMIT"
...
send_webhook "STATE_CHANGED" "$BUILDING_WEBHOOK"
