...
BLOCKED_ENVS="RUNTIME_STARTED_WEBHOOK DOMAIN REPO_BRANCH REPO_CLONE_URI ORCHESTRATOR_URL GITHUB_REPO_FULLNAME CONTAINER_ID WEBHOOK_URI   FAILED_WEBHOOK PROVISIONING_WEBHOOK BUILDING_WEBHOOK PRODUCTION_WEBHOOK TERMINATED_WEBHOOK  CLONE_TOKEN  SOFT_MEMORY_LIMIT COMMIT_HASH BUILD_ID CURR_ENV_ID ENVIRONMENT_TYPE INSTANCE_MEMORY_LIMIT APPLICATION_MEMORY_LIMIT"
