...
COPY --from=builder /app/apps/services/gateway/dist ./apps/services/gateway/dist
COPY --from=builder /app/apps/services/gateway/package.json ./apps/services/gateway/package.json
...
COPY --from=builder /app/apps/services/gateway/node_modules ./apps/services/gateway/node_modules
