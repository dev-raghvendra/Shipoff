...
import { AllDeploymentsResponse, AllProjectsResponse, BodyLessRequest, BulkResourceRequest, CheckDomainAvailabilityRequest, CheckDomainAvailabilityResponse, CreateProjectRequest, CreateRepositoryRequest, DeleteDeploymentRequest, DeleteEnvVarsRequest, DeleteProjectRequest, DeleteRepositoryRequest, DeploymentResponse, DomainAvailabilityResponseData, GetAllDeploymentsRequest, GetAllUserProjectsRequest, GetDeploymentRequest, GetEnvVarsRequest, GetProjectRequest, GetProjectsLinkedToTeamRequest, GetRepositoryRequest, ProjectResponse, ProjectsLinkedToTeamResponse, ProjectsServiceClient, RedeployRequest, UpdateProjectRequest, UpsertEnvVarsRequest } from "@shipoff/proto";
...
export class ProjectService {
    ...
    async createProject(data: any): Promise<InferResponse<ProjectResponse>> {
        try {
            ...
            return response as InferResponse<typeof response>;
        } catch (e:any) {
            return e;
        }
    }

    async getAllUserProjects(data: any): Promise<InferResponse<AllProjectsResponse>> {
        try {
    ...
    async getProjectsLinkedToTeam(data: any): Promise<InferResponse<ProjectsLinkedToTeamResponse>> {
        try {
    ...
    async checkDomainAvailability(data: any): Promise<InferResponse<CheckDomainAvailabilityResponse>> {
        try {
    ...
    async getLatestProjects(data: any): Promise<InferResponse<AllProjectsResponse>> {
        try {
    ...
    async getLatestDeployments(data: any): Promise<InferResponse<AllDeploymentsResponse>> {
        try {
            const req = BulkResourceRequest.fromObject(data);
    ...
    async getProject(data: any): Promise<InferResponse<ProjectResponse>> {
        try {
    ...
    async updateProject(data: any): Promise<InferResponse<ProjectResponse>> {
        try {
    ...
    async deleteProject(data: any): Promise<InferResponse<ProjectResponse>> {
        try {
    ...
    async getAllDeployments(data: any): Promise<InferResponse<AllDeploymentsResponse>> {
        try {
    ...
    async getDeployment(data: any) : Promise<InferResponse<DeploymentResponse>> {
        try {
    ...
    async deleteDeployment(data: any) : Promise<InferResponse<DeploymentResponse>> {
        try {
    ...
    async redeploy(data: any) : Promise<InferResponse<DeploymentResponse>> {
        try {
