...
-- CreateEnum
CREATE TYPE "DeploymentStatus" AS ENUM ('QUEUED', 'INACTIVE', 'FAILED', 'PRODUCTION', 'BUILDING', 'PROVISIONING');
...
-- CreateIndex
CREATE UNIQUE INDEX "Framework_keywordName_key" ON "Framework"("keywordName");

-- CreateIndex
CREATE UNIQUE INDEX "Repository_githubInstallationId_key" ON "Repository"("githubInstallationId");
