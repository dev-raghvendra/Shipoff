...
BLOCKED_ENVS="DOMAIN REPO_BRANCH REPO_CLONE_URI ORCHESTRATOR_URL GITHUB_REPO_FULLNAME CONTAINER_ID WEBHOOK_URI   FAILED_WEBHOOK PROVISIONING_WEBHOOK RUNNING_WEBHOOK PRODUCTION_WEBHOOK TERMINATED_WEBHOOK  CLONE_TOKEN BUILD_COMPLETED COMMIT_HASH MEMORY_LIMIT COMMIT_HASH"
CRR_ENV_ID=$BUILD_ID
