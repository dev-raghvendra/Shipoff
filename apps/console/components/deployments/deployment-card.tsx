  ...
  return (
    <Card onClick={(e:any)=>{
      ...
      {(canRedeploy || canDelete) && (
        <div
          className="absolute inset-0 bg-gradient-to-l dark:from-black/80 dark:via-black/50 via-50% to-transparent opacity-0 group-hover:opacity-100 from-gray-100  transition-opacity flex items-center justify-end px-6 pointer-events-none group-hover:pointer-events-auto"
        >
